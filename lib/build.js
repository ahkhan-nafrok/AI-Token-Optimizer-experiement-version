...
export async function buildTier1(repoInput, token, onProgress = () => {}, cache = {}) {
  ...
  return {
    ...
    // timestamp, which is what the Project Knowledge Manager uses as the
    // actual upstream-staleness signal, independent of when the user last
    // pushed it into Claude's Project Knowledge.
    repoMeta: {
