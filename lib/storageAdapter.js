...
// outside a browser. projectsView.js also uses this directly (not through
// projectStore) for the account-level ghToken/ghContributionCache/
// ghRecentRepos keys, which live outside the `projects` storage key.
